...
<nav class="navbar navbar-expand-lg navbar-light shadow-sm py-2 bg-light">
    <div class="container-fluid px-5">
        ...
        <!-- Taskboard Logo -->
        <a class="navbar-brand fw-bold text-dark d-flex align-items-center" href="UserManager.php">
        ...
        <ul class="navbar-nav me-auto">
            ...
            <!-- User Manager -->
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center px-3" href="UserManager.php"><small>จัดการบัญชี</small></a>
            </li>

            <!-- Create User -->
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center px-3" href="CreateUser.php"><small>สร้างบัญชี</small></a>
            </li>
