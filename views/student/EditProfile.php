...
$profileData = [
    'phone'  => $user['s_phone'] ?? '',
    'gender' => strtolower($user['s_gender'] ?? '')
];
?>
...
<div class="container mt-4 mb-5 w-75">
    ...
    <div class="card p-5">
        <form action="../../controllers/UpdateProfileController.php" method="POST">
            ...
            <!-- Account -->
            <h5 class="section-header">ข้อมูลผู้ใช้งาน</h5>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="student_code" class="form-control"
                           value="<?= htmlspecialchars($user['student_code']) ?>" required>
                </div>

                <div class="col-md-4 mb-3">
                    <label class="form-label fw-bold"><small>สาขา</small></label>
                    <input type="text" name="major" class="form-control"
                           value="<?= htmlspecialchars($user['major']) ?>" required>
                </div>
